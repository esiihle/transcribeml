    ...
    return (
        <main className='flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 w-full max-w-prose mx-auto'>
            ...
            <div className='flex items-center justify-between gap-4'>
                ...
                <button onClick={handleFormSubmission} className='special-btn px-3 py-2 rounded-lg text-blue-400 flex items-center gap-2 font-medium'>
                    <p>Transcribe</p>
                    <i className="i-fa-solid-pen-nib"></i>
                </button>
            </div>
        </main>
    )
