...
export default function Information(props) {
    ...
    return (
        <main className='flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 max-w-prose w-full mx-auto'>
            ...
            <div className='grid grid-cols-2 sm:mx-auto bg-white rounded overflow-hidden items-center p-1 blue-shadow border-2 border-solid border-blue-300'>
            ...
            <div className='my-8 flex flex-col-reverse max-w-prose w-full mx-auto gap-4'>
                {(!finished || translating) && (
                    <div className='grid place-items-center'>
                        <i className="i-fa-solid-spinner animate-spin"></i>
                    </div>
                )}
                {tab === 'transcription' ? (
            ...
            <div className='flex items-center gap-4 mx-auto '>
                ...
                <button onClick={handleDownload} title="Download" className='bg-white hover:text-blue-500 duration-200 text-blue-300 px-2 aspect-square grid place-items-center rounded'>
                    <i className="i-fa-solid-download"></i>
                </button>
            </div>
        </main>
    )
